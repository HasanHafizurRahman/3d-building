...
export default async function FloorPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
            {/* Floating Back Button (enhanced hover effects) */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                {/* Hero Section - Map with Overlays (added lazy loading) */}
                <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-12 group">
                    <div className="relative h-[600px]">
                        <Image
                            ...
                            loading="lazy"
                        />
                        {/* Gradient Overlays (enhanced vibrancy) */}
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/40 to-purple-600/40 mix-blend-multiply" />

                        {/* Floating Info Cards (added animations) */}
                        ...
                        {/* Bottom Content (improved typography) */}
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-12">
                    {/* Main Content - 2 columns (enhanced cards) */}
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        {/* Benefits Section */}
                        <div className="bg-gradient-to-br from-white/70 to-blue-50/70 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-xl border border-white/50">
                    ...
                    {/* Sidebar - 1 column (enhanced stickiness and CTAs) */}
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/50 transition-all hover:shadow-2xl">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-transparent rounded-xl transition-all hover:bg-blue-100">
                        ...
                        {/* CTA Card */}
                        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 shadow-2xl text-white sticky top-6 transition-all hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]">
                            ...
                            <div className="space-y-3">
                                ...
                                <button className="w-full bg-blue-500/30 backdrop-blur-sm hover:bg-blue-500/40 text-white font-bold py-4 px-6 rounded-xl transition-all border-2 border-white/30 hover:border-white/50">
                                    Contact Agent
                                </button>
                            </div>
